...
# nums_week: 1週あたりの放送回数
KOUZALIST: List[Tuple[str, str, str, int]] = [
    ("ラジオ英会話", "0916", "000009137{month:02d}{year:04d}", 5),
    ("英会話タイムトライアル", "2331", "000009105{month:02d}{year:04d}", 5),
    # ("高校生からはじめる「現代英語」", "4407", "000009535{month:02d}{year:04d}", 2),
    # ("ラジオビジネス英語", "6809", "000008825{month:02d}{year:04d}", 2),
    # ("まいにちスペイン語（初級編）", "0948", "000009145{month:02d}{year:04d}", 3),
    # ("まいにちスペイン語（入門編）", "0948", "000009145{month:02d}{year:04d}", 3),
    # ("まいにちスペイン語（中級編）", "4413", "000009145{month:02d}{year:04d}", 2),
    ("まいにちスペイン語（応用編）", "4413", "000009145{month:02d}{year:04d}", 2),
    # ("まいにちロシア語（初級編）", "0956", "000009147{month:02d}{year:04d}", 3),
    # ("まいにちロシア語（入門編）", "0956", "000009147{month:02d}{year:04d}", 3),
    ("まいにちロシア語（応用編）", "4414", "000009147{month:02d}{year:04d}", 2),
    # ("まいにちフランス語（初級編）", "0953", "000009113{month:02d}{year:04d}", 3),
    # ("まいにちフランス語（入門編）", "0953", "000009113{month:02d}{year:04d}", 3),
    ("まいにちフランス語（応用編）", "4412", "000009113{month:02d}{year:04d}", 2),
    # ("まいにちドイツ語（初級編）", "0943", "000009109{month:02d}{year:04d}", 3),
    # ("まいにちドイツ語（入門編）", "0943", "000009109{month:02d}{year:04d}", 3),
    ("まいにちドイツ語（応用編）", "4410", "000009109{month:02d}{year:04d}", 2),
    # ("まいにちイタリア語（初級編）", "0946", "000009159{month:02d}{year:04d}", 3),
    # ("まいにちイタリア語（入門編）", "0946", "000009159{month:02d}{year:04d}", 3),
    ("まいにちイタリア語（応用編）", "4411", "000009159{month:02d}{year:04d}", 2),
    # ("まいにち中国語", "0915", "000009101{month:02d}{year:04d}", 5),
    # ("ステップアップ中国語", "6581", "000009099{month:02d}{year:04d}", 2),
    ("ステップアップ中国語", "6581", "00006213356{year:04d}", 2),  # TODO 月部分が不明なので11月号発売を見て調整
    # ("まいにちハングル講座", "0951", "000009277{month:02d}{year:04d}", 5),
    ("ステップアップハングル講座", "6810", "00006213364{year:04d}", 2),  # TODO 月部分が不明なので11月号発売を見て調整
    # ("ポルトガル語講座", "2769", "00006213285{annual:04d}", 1),
    # ("ポルトガル語講座入門", "1893", "00006213285{annual:04d}", 1),
    # ("ポルトガル語講座ステップアップ", "2769", "00006213285{annual:04d}", 1),
]
