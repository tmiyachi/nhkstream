...
KOUZALIST: List[Tuple[str, str, str]] = [
    ...
    # ("まいにちスペイン語（中級編）", "4413", "000009145{month:02d}{year:04d}"),
    ("まいにちスペイン語（応用編）", "4413", "000009145{month:02d}{year:04d}"),
    # ("まいにちロシア語（初級編）", "0956", "000009147{month:02d}{year:04d}"),
    # ("まいにちロシア語（入門編）", "0956", "000009147{month:02d}{year:04d}"),
    ("まいにちロシア語（応用編）", "4414", "000009147{month:02d}{year:04d}"),
    # ("まいにちフランス語（初級編）", "0953", "000009113{month:02d}{year:04d}"),
    ...
    # ("まいにちイタリア語（初級編）", "0946", "000009159{month:02d}{year:04d}"),
    ...
    ("ステップアップ中国語", "6581", "00006213356{year:04d}"),  # TODO 月部分が不明なので11月号発売を見て調整
    # ("まいにちハングル講座", "0951", "000009277{month:02d}{year:04d}"),
    ("ステップアップハングル講座", "6810", "00006213364{year:04d}"),  # TODO 月部分が不明なので11月号発売を見て調整
    # ("ポルトガル語講座", "2769", "00006213285{annual:04d}"),
    # ("ポルトガル語講座入門", "1893", "00006213285{annual:04d}"),
    # ("ポルトガル語講座ステップアップ", "2769", "00006213285{annual:04d}"),
]
